...
public class UserController {
    ...
    public String registration(Model model) {
        ...
        model.addAttribute("passwordTypeError",null);
    ...
    public String registerUser(User user,Model model) {
        ...
        Matcher sp = special.matcher(user.getPassword());
        Matcher num = number.matcher(user.getPassword());
        Matcher alph = alpha.matcher(user.getPassword());
        if(sp.find() == false| num.find() == false| alph.find() == false){
            model.addAttribute("User", user);
